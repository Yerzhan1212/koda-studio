...
const SERVICES = [
  ...
  },
  {
    ...
    bullets: ["REST API на Go / Node.js", "Базы данных PostgreSQL", "Приём онлайн-оплаты (Kaspi, карты)", "Интеграции с CRM и мессенджерами"],
  },
  {
    icon: Wrench,
      ...
      <div className="max-w-[1180px] mx-auto px-8">
        <Reveal className="max-w-[640px] mb-14">
          ...
          <p style={{ color: T.ink500 }}>
            Фронтенд на React, бэкенд на Go — сочетание, которое даёт быстрый интерфейс и надёжную систему под ним. Ниже — подробнее, что входит в каждое направление.
          </p>
        </Reveal>
